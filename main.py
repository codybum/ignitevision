...
def training(local_rank, config):
    ...
    logger = setup_logger(name="Ignite-Vision-Training")
    ...
    if rank == 0:
        ...
        if config["with_clearml"]:
            try:
                ...
                logger.error("clearML could not be loaded")

            task = Task.init("Ignite-Vision-Training", task_name=output_path.stem)
